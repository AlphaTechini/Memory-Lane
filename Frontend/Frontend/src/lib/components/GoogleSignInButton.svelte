<script>
  ...
  async function handleGoogleSignIn() {
    console.log('handleGoogleSignIn called', { loading, disabled, firebaseAuth: !!firebaseAuth });
    ...
    try {
      if (!firebaseAuth) {
        throw new Error("Google sign-in not available yet. Please refresh the page.");
      }
      ...
      console.log('Google sign-in popup successful, getting ID token...');
