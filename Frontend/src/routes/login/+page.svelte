...
<svelte:head>
  ...
  <meta name="description" content="Log in securely to access your AI memory replicas." />
</svelte:head>
      ...
      <div class="card-accessible">
        ...
        <form onsubmit={handleLogin} class="space-y-6">
          ...
          <div>
            ...
            {#if userType === 'patient'}
              <p class="text-accessible-sm text-charcoal-600 dark:text-cream-300 mb-2">
                Enter the email your caretaker used to add you
              </p>
            {/if}
            <input
        ...
        <div class="mt-8 pt-6 border-t-2 border-cream-300 dark:border-charcoal-600">
          <div class="text-center space-y-4">
            <p class="text-accessible-base text-charcoal-600 dark:text-cream-300">
              ...
              <a href="/signup" class="font-semibold text-teal-600 dark:text-teal-400 hover:underline focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 rounded">
                Sign up
              </a>
            </p>
