    ...
    <div class="fixed top-0 left-0 w-full z-50">
      <div class="bg-teal-500 text-white text-center px-6 py-4 shadow-lg relative" role="alert">
        ...
        <p class="text-accessible-base">
          ...
          <a href="/feedback" class="font-bold underline hover:text-cream-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-teal-500 rounded">
