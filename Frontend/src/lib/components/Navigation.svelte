...
>
  <div class="max-w-6xl mx-auto flex items-center justify-between">
    ...
    <a
      href="/dashboard"
      class="flex items-center gap-3 min-h-[40px] px-3 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
    ...
    >
      <div class="flex flex-col gap-3">
        ...
        >
          ...
          <span class="text-base font-semibold">Photos</span>
        </button>
        ...
        {#if userRole !== "patient"}
          ...
          >
            ...
            <span class="text-base font-semibold">Create Replica</span>
          </button>

          <button
            onclick={() => {
              goto("/manage-patients");
              showMobileMenu = false;
            }}
            class="flex w-full items-center gap-4 px-4 py-3 rounded-xl text-left {currentPath.startsWith(
              '/manage-patients',
          ...
          >
            ...
            <span class="text-base font-semibold">Manage Patients</span>
          </button>
        {/if}
